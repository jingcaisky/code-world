...
|----------|---------|-------------|
| `PROJECT_NAME` | `multi_agent` | Display name for the project |
...
| `LOGFIRE_SERVICE_NAME` | `multi_agent` | Service name in Logfire dashboard |
...
| `LANGCHAIN_PROJECT` | `multi_agent` | Project name in LangSmith |
