    ...
    <div className="space-y-6">
      ...
      {!loading && summary && summary.ratings_by_day.length > 0 && (
        <section className="border-border bg-card rounded-xl border p-6">
          <h2 className="text-foreground text-sm font-semibold">每日评分</h2>
          <p className="text-muted-foreground text-xs">最近 30 天的喜欢和不喜欢。</p>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="positive">仅喜欢</SelectItem>
              <SelectItem value="negative">仅不喜欢</SelectItem>
            </SelectContent>
          </Select>
          <label className="flex cursor-pointer items-center gap-2 text-xs">
            ...
            />
            <span className="text-muted-foreground">仅有评论</span>
          </label>
        </div>
        {ratings && !loading && (
      ...
      <DataTable
        ...
        empty={
          <div className="py-8">
            ...
            <p className="text-foreground text-sm">未找到评分。</p>
            <p className="text-muted-foreground mt-1 text-xs">试着调整上方筛选条件。</p>
          </div>
        }
      />
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between">
          <span className="text-muted-foreground font-mono text-[11px] tracking-wider uppercase">
            第 {page + 1} 页 / 共 {totalPages} 页 · 共 {ratings?.total.toLocaleString()} 条
          </span>
