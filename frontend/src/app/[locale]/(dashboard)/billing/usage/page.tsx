      ...
      {isLoading ? (
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <StatCard
            ...
            icon={Coins}
          />
          <StatCard label="词元" value={totalTokens?.toLocaleString() ?? "—"} icon={Cpu} />
          <StatCard
            label="接口调用"
          ...
          <div className="divide-border -mx-1 divide-y">
            {aggregate.by_model.map((m) => (
              <div key={m.model} className="grid grid-cols-4 gap-4 px-1 py-3 text-sm tabular-nums">
                ...
                <div>
                  <p className="text-muted-foreground text-xs">词元</p>
