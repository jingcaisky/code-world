...
export function PrivacyBodyEn() {
  return (
    <>
      ...
      <ul>
        <li>
          <strong>账户信息</strong> — name, email, hashed password, optional avatar.
        </li>
        <li>
          <strong>客户数据</strong> — prompts, documents you upload, chat conversations,
          knowledge base content.
        </li>
        <li>
          <strong>账单信息</strong> — handled by our payment processor (Stripe). We never see
          your card number.
        </li>
        <li>
          <strong>支持往来信件</strong> — when you email us.
        </li>
      </ul>
      <h3>自动收集的信息</h3>
      <ul>
        <li>
          <strong>使用数据</strong> — request paths, response times, feature usage, error stack
          traces.
        </li>
        <li>
          <strong>设备数据</strong> — browser, OS, IP address (for security and rate limiting).
        </li>
        <li>
          <strong>Cookies</strong> — see our <Link href={ROUTES.LEGAL_COOKIES}>Cookie 政策</Link>.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <strong>权限</strong> if required by law, but we&apos;ll push back where we can and
      ...
      <p>
        ...
        actions. See the <Link href={ROUTES.SECURITY}>安全页面</Link> 查看详情。
      </p>
...
export function PrivacyBodyPl() {
  return (
    <>
      ...
      <ul>
        <li>
          <strong>账户数据</strong> — imię, email, zhashowane hasło, opcjonalny avatar.
        </li>
        <li>
          <strong>客户数据</strong> — prompty, wgrywane dokumenty, rozmowy z czatu, zawartość
          baz wiedzy.
        </li>
        <li>
        ...
        <li>
          <strong>支持信件往来</strong> — gdy do nas piszesz.
        </li>
      </ul>
      <h3>自动收集的信息</h3>
      <ul>
      ...
      <ul>
        ...
        <li>
          <strong>机构</strong> jeśli wymaga tego prawo, ale walczymy gdzie możemy i powiadamiamy
          dotkniętych użytkowników gdzie jest to prawnie dozwolone.
        </li>
        <li>
          <strong>买家</strong> w przypadku fuzji lub sprzedaży, z zachowaniem zobowiązań tej
          Polityki.
        </li>
      </ul>
