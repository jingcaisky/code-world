    ...
    >
      ...
      <div className="relative grid grid-cols-3 items-center gap-6 md:gap-12">
        <div className="space-y-2.5">
          <p className="eyebrow text-foreground/55 mb-4">文档源</p>
        ...
        <div className="flex justify-center">
          ...
          >
            ...
            <div className="relative z-10 text-center">
              <p className="eyebrow text-foreground/55 mb-1.5">知识库</p>
        ...
        <div className="space-y-4">
          ...
          <p className="eyebrow text-foreground/55">助理</p>
          ...
          >
            ...
            <div className="relative">
              <div className="text-foreground/55 mb-2 flex items-center gap-1.5">
                ...
                <span className="font-mono text-[10px] tracking-wider uppercase">回答</span>
              </div>
